...
/*********************************************************************************************************
** 函数名称: yaffs_verify_blk
** 功能描述: 校验指定块的状态信息，如果我们打开了相应的 log 开关，那么在出错的时候会打印 log 信息
** 输	 入: dev - yaffs 设备
**		   : bi - 需要判断的块信息
**		   : n - 需要判断的块号
 ** 输	 出: 
...
/*********************************************************************************************************
** 函数名称: yaffs_verify_oh
** 功能描述: 校验指定对象的头信息是否正确，如果不正确，并且开启了相关 log 信息开关，就会打印错误信息
**         : 主要是通过校验对象的 tags 信息和对象本身信息来校验 header 信息
** 输 	 入: obj - 需要校验的目标对象
**         : oh - 校验对象的头信息
**         : tags - 校验对象的 tags 信息（这个信息在所有 header chunk 和 data chunk 中都是一样的？）
**         : parent_check - 
** 输 	 出: 
** 全局变量: 
** 调用模块: 
